...
public class IdTypeAzureSqlDAO extends ConnectionSQL implements IdTypeDAO {
	...
	private List<IdTypeDTO> assembleResults(ResultSet resultSet) {
		...
		try {
			...
			throw QuotesException.buildTechnicalDataException("There was a problem trying to recover the id types",
					exception);
	...
	private IdTypeDTO assembleDTO(ResultSet resultSet) {
		...
		try {
			...
			throw QuotesException.buildTechnicalDataException("There was a problem trying to assemble the id types",
					exception);
